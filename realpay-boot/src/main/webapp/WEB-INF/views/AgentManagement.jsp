...
<html lang="en">
  ...
  <body ng-app="myApp" class="ng-cloak">
      <div class="generic-container" ng-controller="AgentController as ctrl">
      ...
      <script src="<c:url value='/static/js/service/agent_service.js' />"></script>
      <script src="<c:url value='/static/js/controller/agent_controller.js' />"></script>
  </body>
</html>